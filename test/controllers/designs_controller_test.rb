...
class DesignsControllerTest < ActionController::TestCase
  ...
  test "should create design" do
    assert_difference('Design.count') do
      post :create, design: { category_id: @design.category_id, description: @design.description, name: @design.name, slug: @design.slug }
    end
  ...
  test "should update design" do
    patch :update, id: @design, design: { category_id: @design.category_id, description: @design.description, name: @design.name, slug: @design.slug }
    assert_redirected_to design_path(assigns(:design))
  end
